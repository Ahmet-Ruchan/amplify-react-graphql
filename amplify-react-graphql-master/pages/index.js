      ...
      <main className=" px-3.5 bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-200">
              <a href="https://medium.com/@Ahmet_Ruchan_Avci" target="_blank" rel="noreferrer"><AiFillMediumCircle /></a>
        ...
        <section className="py-10">
          <div>
            ...
            <br/>  <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-cyan-400 to-yellow-300"> JavaScript, Java, C, Python, ReactJS, NodeJS, VueJs, MongoDB, HTML and CSS </span>
          ...
          <br/><br/><br/><h5 className="text-m py-1 text-white text-center p-10">Copyright <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-400  to-cyan-400">2023 </span>. All rights reserved. ©</h5>
        </section>
      </main>
    </div>
  );
